  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
        Have any questions or need support? Get in touch with us using the form below or contact us directly.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Contact Form */}
        <div className="bg-white shadow-lg rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-pink-600 mb-6">Send Us a Message</h2>
        ...
        {/* Contact Details */}
        <div className="bg-white shadow-lg rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-pink-600 mb-6">Contact Information</h2>
